...
import { TrainCar } from '../entities/TrainCar/TrainCar';
import { Attachment, AttachmentSlotType } from '../entities/Attachment/Attachment';
...
export class TrainCarModificationUI {
    ...
    constructor() {
        // Enable console output for Logger/EventStack logs during development
        eventStack.updateConfig({ consoleOutputEnabled: true });
