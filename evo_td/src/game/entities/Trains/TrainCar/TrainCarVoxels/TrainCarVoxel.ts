...
import { RadiusComponent, createCollisionRadius } from '../../../../../engine/components/RadiusComponent';
 ...
 */
export class TrainCarVoxel extends GameNodeObject {
    ...
    constructor(
        ...
        eventStack?: any,
        scene?: Scene,
        parentSceneNode?: NodeComponent
    ) {
        super('trainCarVoxel', eventStack, scene, parentSceneNode);
        ...
        if (this.scene) {
            const sceneNode = new NodeComponent(this.scene, parentSceneNode);
    ...
    /**
     * Emit damage to nearby voxels (for explosion propagation)
     */
