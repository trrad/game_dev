...
import { VoxelFace, VoxelMaterial, CargoCapacityType } from "../../../game/components/TrainCarVoxelComponent";
...
export class TrainCarVoxel extends GameObject {
    ...
    constructor(
        ...
        parentSceneNode?: NodeComponent  // Parent scene node for hierarchy
    ) {
