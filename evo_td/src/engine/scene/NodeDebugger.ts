/**
 * NodeDebugger - Visual debugging tools for scene node hierarchy
...
/**
 * NodeDebugger provides visual tools for debugging scene node hierarchies
 */
export class NodeDebugger {
    private _scene: Scene;
    private _options: NodeDebugOptions;
     ...
     */
    constructor(scene: Scene, options: NodeDebugOptions = {}) {
        this._scene = scene;
        this._options = {
        ...
        this._lineMaterial = new StandardMaterial('NodeDebugLineMaterial', scene);
     ...
     */
    updateOptions(options: Partial<NodeDebugOptions>): void {
        this._options = {
            ...this._options,
            ...options
        };
